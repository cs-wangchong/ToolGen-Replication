...
if __name__ == '__main__':
    ...
    DIR = f"models-lsp/codet5p-220m-py-231101-123852"
    # TIMESTAMP = time.strftime("%y%m%d-%H%M%S", time.localtime())
    TIMESTAMP = "231102-052506"
    ...
    if SAMPLED:
        ...
        logging.info(f"[Testing] CALL LSP, blue-4: {round(bleu, 4)}, codebleu: {round(codebleu, 4)}, lsp hit rate: {round(hit_rate, 4)}, lint success rate: {round(succ_rate, 4)}") 
