...
from coder.lsp_coder_codellama import LSPCoder
...
if __name__ == '__main__':
    ...
    DIR = f"models-lsp/CodeLlama-7b-Python-hf-231029-032915"
    ...
    generator = CodeLlamaGenerator.load_from_model_info(f"{DIR}/model.json", device="cuda")
    # if SAMPLED:
